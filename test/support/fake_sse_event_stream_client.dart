...
class FakeSseEventStreamClient implements SseEventStreamClient {
  ...
  StreamController<ApiSseEvent> _controllerFor(String endpoint) => _controllers
      .putIfAbsent(endpoint, StreamController<ApiSseEvent>.broadcast);
  ...
  void emit(
    ...
    _controllerFor(endpoint).add(ApiSseEvent(id: id, event: event, data: data));
  }

...
## AppEmptyState
- **路径**: `lib/widgets/app_shell/app_empty_state.dart`
...
## AppSectionError(桌面)
- **路径**: `lib/widgets/feedback/app_section_error.dart`
...
- **路径**: `lib/widgets/feedback/app_mobile_section_error.dart`
...
## AppSectionSkeleton
- **路径**: `lib/widgets/feedback/app_section_skeleton.dart`
- **用途**: 桌面通用"多行骨架条"。
- **required**: `lineCount`
- **何时用**: 桌面页 section 加载中态。

## AppSkeletonBlock
- **路径**: `lib/widgets/feedback/app_mobile_skeleton.dart`
...
- **路径**: `lib/widgets/feedback/app_confirm_dialog.dart`
